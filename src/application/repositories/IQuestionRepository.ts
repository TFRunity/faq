...
export interface IQuestionRepository {
    ...
    getAllWithoutCategory() : Promise<QuestionWithLatestAnswer> //Получение плоских данных вопросов, которые не относятся ни к какой категории, (ТЕ ЧТО НА МОДЕРАЦИИ)
